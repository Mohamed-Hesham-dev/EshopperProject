      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/allproducts')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>all products</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/AllCategories')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>all category</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/AllReview')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>AllProductReviews</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{url('admin/logoutadmin')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
                  <p>LogOut</p>
          </li>
